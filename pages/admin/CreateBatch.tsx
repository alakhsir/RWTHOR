...
import { availableSubjects } from '../../services/mockData';
...
export const CreateBatch = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const batchPayload = {
            ...
            features: features,
            subjectIds: [] // This might need a separate relation table if strictly normalized
        };

        try {
            if (batchId) {
                await api.updateBatch(batchId, batchPayload);
